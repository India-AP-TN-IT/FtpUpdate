...
namespace FTP_Downloader
{
    public partial class frmMain : Form
    {
        ...
        private bool getLoadIniData()
        {
            ...
            m_sProcessInfo.passiveMode = IniControl.ReadBool(strFileName, "FTP_SERVER", "FTP_PASSIVE");
            //GENERAL
        ...
        private void setDownLoad()
        {
            try
            {
                ...
                List<FtpHelper.ftpinfo> listFullSub = helper.GetFullFilesList(m_sProcessInfo.passiveMode);
                ...
                foreach (FtpHelper.ftpinfo name in listFullSub)
                {
                    ...
                    helper.FileDownLoad(name, m_sProcessInfo.passiveMode, ref strErr);
                    iFile++;
                }
                if (!m_bExit)
                {
